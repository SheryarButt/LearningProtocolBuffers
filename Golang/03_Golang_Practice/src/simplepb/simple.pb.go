...
func (x *SimplePerson) GetFirstName() string {
	if x != nil {
		return x.FirstName
	}
	return ""
...
func (x *SimplePerson) GetLastName() string {
	if x != nil {
		return x.LastName
	}
	return ""
...
func (x *SimplePerson) GetSmallPicture() []byte {
	if x != nil {
...
func (x *SimplePerson) GetIsProfileVerified() bool {
	if x != nil {
...
func (x *SimplePerson) GetHeight() float32 {
	if x != nil {
		return x.Height
	}
	return 0
...
var file_simple_simple_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x70, 0x6c, 0x65, 0x22, 0xc9, 0x01, 0x0a, 0x0c, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65,
	...
	0x74, 0x42, 0x0b, 0x5a, 0x09, 0x2f, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x70, 0x62, 0x62, 0x06,
...
var file_simple_simple_proto_goTypes = []interface{}{
	(*SimplePerson)(nil), // 0: example.simple.SimplePerson
}
